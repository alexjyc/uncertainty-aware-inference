"""
Full evaluation — Llama-2 7B GPTQ INT4.
Requires: gptqmodel installed (pip uninstall auto-gptq -y && pip install gptqmodel).

Usage:
    HF_TOKEN=<token> python TeamA/eval_gptq_int4.py
"""
import os
import sys
...
CONFIG_KEY  = "llama2-7b-gptq-int4"
OUTPUT_DIR  = "TeamA/results/gptq_int4"
MAX_SAMPLES = 100
